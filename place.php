...
<body>
				...
				<!--/*<ul>
					<h2><a href="place.php?cnm=location">location</a></h2><br /><br />
					<h2><a href="place.php?cnm=Historical Place">historicle place</a></h2><br /><br />
					<h2><a href="place.php?cnm=museum">museum</a></h2>
       ...
       <!-- <form action="place_detail.php" method="post">-->
	...
	<?php 
		   ...
		   echo $s;
 	       ...
 	       $sql="select * from img where maincat_name='".$m."' and subcat_name='".$s."'";
	       ...
	       while($row=mysql_fetch_array($result))
	       {
			...
			echo'<table cellpadding="5" border="3" bordercolor="#FFFFFF"><tr><td style="margin-left:20px;"> <img src="admin/'.$row['img_path'].'" width="400" height="400" align="left"></td>';	
				
			//echo "<font align='center'>".$row['img_nm']."";
			echo "<td><table border='5' bordercolor='#FFFFFF' ><tr><td>&nbsp;  &nbsp;&nbsp;&nbsp;   </td><td><font align='center'>".$row['img_title']."</font></td></tr>";
			
			//echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font align='center'>".$row[' maincat_name']."</font><br>";
			//echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font align='center'>".$row['subcat_name']."</font><br>";
			echo "<tr><td>    &nbsp;&nbsp;&nbsp;&nbsp;      </td> <td><font align='center'>".$row['short_discription']."</font></td></tr>";
			echo "<tr><td>     &nbsp;&nbsp;&nbsp;&nbsp;     </td><td><font align='center'>".$row['long_discription']."</font></td></tr></table></td></tr></table>";
